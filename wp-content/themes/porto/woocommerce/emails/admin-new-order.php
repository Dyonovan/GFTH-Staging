...
<table cellspacing="0" cellpadding="6" style="width: 100%; border: 1px solid #eee;" border="1" bordercolor="#eee">
	<thead>
		<tr>
			...
			<th scope="col" style="text-align:left; border: 1px solid #eee;"><?php _e( 'Options', 'woocommerce' ); ?></th>
		...
		<?php
			if ( $totals = $order->get_order_item_totals() ) {
				...
				foreach ( $totals as $total ) {
					$i++;
					?><tr>
						<th scope="row" colspan="3" style="text-align:right; border: 1px solid #eee; <?php if ( $i == 1 ) echo 'border-top-width: 4px;'; ?>"><?php echo $total['label']; ?></th>
