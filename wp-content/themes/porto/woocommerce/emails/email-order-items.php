...
foreach ( $items as $item_id => $item ) :
	...
	if ( apply_filters( 'woocommerce_order_item_visible', true, $item ) ) {
		...
		<tr class="<?php echo esc_attr( apply_filters( 'woocoomerce_order_item_class', 'order_item', $item, $order ) ); ?>">
			...
			?></td>
			<td style="text-align:left; vertical-align:middle; border: 1px solid #eee;"><small><?php echo str_replace("Authenic Grey Barnboard Frame: ", "BB: ", str_replace("Size: ", "", $item_meta->display( true, true, '_', ", " ))) ?> </small>
